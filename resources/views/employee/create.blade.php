                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                ...
                                                onfocusout="defocused(this)" name="department">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                placeholder="input address" onfocus="focused(this)"
                                                onfocusout="defocused(this)" name="address">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="exampleFormControlInput1"
                                                placeholder="input nik" onfocus="focused(this)" onfocusout="defocused(this)"
                                                name="nik">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="exampleFormControlInput1"
                                                placeholder="input DOB" onfocus="focused(this)" onfocusout="defocused(this)"
                                                name="dob">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                ...
                                                onfocusout="defocused(this)" name="birth_place">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="exampleFormControlInput1"
                                                ...
                                                onfocusout="defocused(this)" name="join_age">
                                        </div>
                                    </div>
                                    <div class="form-group">
