    ...
    <ul class="navbar-nav">
      ...
      {{-- <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('roles') ? 'active' : '') }}" href="{{ url('roles') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('roles') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('kehadiran') ? 'active' : '') }}" href="{{ url('kehadiran') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('kehadiran') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
