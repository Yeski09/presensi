    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        ...
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
            ...
            <span class="nav-link-text ms-1">User Profile</span>
                    ...
                    <a class="nav-link {{ Request::is('roles') ? 'active' : '' }}" href="{{ url('roles') }}">
                        <div
                            ...
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('roles') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('employees') ? 'active' : '' }}" href="{{ url('employees') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('employees') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('kehadiran') ? 'active' : '' }}"
                        href="{{ url('kehadiran') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('kehadiran') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item pb-2">
                    <a class="nav-link {{ Request::is('absen') ? 'active' : '' }}"
                        href="{{ url('absen') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i style="font-size: 1rem;"
                                class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ Request::is('absen') ? 'text-white' : 'text-dark' }} "
                                aria-hidden="true"></i>
                        </div>
        ...
        <a class="nav-link {{ (Request::is('pegawai') ? 'active' : '') }}" href="{{ url('pegawai') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('pegawai') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Employee Management</span>
        </a>
      </li> --}}
